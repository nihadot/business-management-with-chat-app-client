...
import { getAdminById, getParentById } from '../api/admin'
  ...
  return (
    ...
    <div className="">
        <Link to={`/user-edit-profile`}>
            ...
            <button type='button' className=' w-fit px-10 py-2 mt-2 rounded-md bg-[#007bff] text-white tex-sm font-medium'>Edit</button>
