...
import { getDoctorById, updateDoctorByIdNoAuth } from '../api/admin';
...
function DoctorsEditProfile() {
    ...
    const handleSubmit = async(e)=>{
        ...
        try {
            ...
            const response = await updateDoctorByIdNoAuth(data,JSON.parse(localStorage.getItem("doctor-details"))._id)
    ...
    const fetchAPI = async()=>{
        try {
            setLoading(true);
            const response = await getDoctorById(JSON.parse(localStorage.getItem("doctor-details"))._id)
