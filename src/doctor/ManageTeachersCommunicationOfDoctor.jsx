...
import {  getAllParents, getAllTeachers } from "../api/admin";

function ManageTeacherCommunicationOfDoctor() {
    ...
    <>
      ...
      {!loading && (
        <div className="flex flex-col">
          <Link
            to={"/doctors/doctor-communication"}
                    ...
                    {data.map((item, index) => {
                      return (
                        ...
                        >
                          ...
                          <td className="whitespace-nowrap px-6 py-4">
                            <Link to={`/doctors/manage-teachers-communication/${item._id}`}>
...
export default ManageTeacherCommunicationOfDoctor;
