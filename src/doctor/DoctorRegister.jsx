...
import { addingDoctor } from "../api/admin";
...
function TeacherRegister() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!IFSCCode) return errorToast("ifsc code is required!");
    if (!accountNumber) return errorToast("Account number is required!");
    if (!branch) return errorToast("Branch name is required!");
    ...
    try {
      ...
      const response = await addingDoctor(data);
  ...
  return (
    ...
    >
      <h1 className="text-4xl mb-5">Register as Doctor</h1>
