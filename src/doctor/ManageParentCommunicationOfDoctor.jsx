...
import {  getAllParents } from "../api/admin";

function ManageParentCommunicationOfDoctor() {
                    ...
                    {data.map((item, index) => {
                      return (
                        ...
                        >
                          ...
                          <td className="whitespace-nowrap px-6 py-4">
                            <Link to={`/doctors/manage-parent-communication/${item._id}`}>
...
export default ManageParentCommunicationOfDoctor;
