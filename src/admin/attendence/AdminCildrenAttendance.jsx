...
import { getAttendanceOfChildrenByNoAuth, getAttendanceOfChildrenByTeacher } from "../../api/admin";
import Spinner from "../../spinner";

function AdminCildrenAttendance() {
  ...
  const goToCurrent = `/admin/view-childrens-attendance/${id}/${name}`;
  ...
  return (
    <div className="bg-white px-4 my-5">
     ...
     <ul className={breadCrumbContainer}>
            ...
            <li className={`${breadCrubmberClassName}`}>
              <Link to={goToParentDir}>Children</Link> <span>/</span>
            </li>
            <li className={`${breadCrubmberClassName}`}>
...
export default AdminCildrenAttendance;
