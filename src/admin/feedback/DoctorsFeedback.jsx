  ...
  return (
    <div>
      ...
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-lg lg:text-2xl font-bold text-gray-900 dark:text-white">Your voice shapes our future: Let us know how we're doing.</h2>
    </div>
  <div className="max-w-2xl mx-auto px-4 h-[400px] overflow-y-scroll">
    <form className="mb-6">
