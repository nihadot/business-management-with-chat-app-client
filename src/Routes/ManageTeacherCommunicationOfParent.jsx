...
import { getAdminsByDoctos, getTeachersWithoutAuth } from "../api/admin";
import Spinner from "../spinner";

function ManageTeacherCommunicationOfParent() {
                    ...
                    {data.map((item, index) => {
                      return (
                        ...
                        >
                          ...
                          <td className="whitespace-nowrap px-6 py-4">
                            <Link to={`/manage-teacher-communication/${item._id}`}>
...
export default ManageTeacherCommunicationOfParent;
