...
import { getAdminsByDoctos, getDoctorsStatusFalse } from "../api/admin";
import Spinner from "../spinner";

function ManageDoctorCommunicationOfParent() {
                    ...
                    {data.map((item, index) => {
                      return (
                        ...
                        >
                          ...
                          <td className="whitespace-nowrap px-6 py-4">
                            <Link to={`/manage-doctor-communication/${item._id}`}>
...
export default ManageDoctorCommunicationOfParent;
