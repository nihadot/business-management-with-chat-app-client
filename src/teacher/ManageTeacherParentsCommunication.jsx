...
import { getParentsRoleTeacher } from "../api/admin";
import Spinner from "../spinner";

function ManageTeacherParentsCommunication() {
  ...
  const fetchAPI = async () => {
    try {
      setLoading(true);
      const response = await getParentsRoleTeacher();
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="whitespace-nowrap px-6 py-4">
                            <Link to={`/teacher/manage-parent-communication/${item._id}`}>
...
export default ManageTeacherParentsCommunication;
