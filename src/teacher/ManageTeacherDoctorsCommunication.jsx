...
import { getDoctorsStatusFalse } from "../api/admin";
import Spinner from "../spinner";

function ManageTeacherDoctorsCommunication() {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="whitespace-nowrap px-6 py-4">
                            <Link to={`/teacher/manage-doctor-communication/${item._id}`}>
...
export default ManageTeacherDoctorsCommunication;
